...
template <> constexpr inline auto MockDataGenerator::qt_create_metaobjectdata<qt_meta_tag_ZN17MockDataGeneratorE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'newData'
        QtMocHelpers::SignalData<void(const EnvData &)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
        // Slot 'generateData'
...
void MockDataGenerator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->newData((*reinterpret_cast<std::add_pointer_t<EnvData>>(_a[1]))); break;
        case 1: _t->generateData(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (MockDataGenerator::*)(const EnvData & )>(_a, &MockDataGenerator::newData, 0))
            return;
    }
}
...
// SIGNAL 0
void MockDataGenerator::newData(const EnvData & _t1)
{
